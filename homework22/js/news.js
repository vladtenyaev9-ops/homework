...
const extraNews = [
  {
    title: 'Как быстро сделать укладку без перегрева',
    text: 'Разбираем простые приемы для ежедневной укладки: как выбрать поток воздуха, насадку и температуру для разных типов волос.',
    date: '2022-10-22',
  },
  {
    title: 'Новые насадки для бережной сушки волос',
    text: 'Рассказываем, какие насадки помогают добавить объем у корней, разгладить длину и сохранить естественный блеск волос.',
    date: '2022-10-23',
  },
  {
    title: 'Почему важно контролировать температуру',
    text: 'Стабильная температура помогает защищать волосы во время сушки и делает укладку более предсказуемой каждый день.',
    date: '2022-10-24',
  },
];
...
const createNewsArticle = ({ title, text, date }) => {
